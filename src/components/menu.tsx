    ...
    <Sheet>
      ...
      >
        ...
        <div
          ...
          className="-top-36 absolute right-0 -z-10 h-[160px] w-[850px] origin-bottom-right -rotate-90 transform bg-cover bg-no-repeat opacity-20"
        />
        ...
        <SheetHeader>
          ...
          <SheetDescription className="flex w-full justify-center py-2 font-mono text-2xl">
